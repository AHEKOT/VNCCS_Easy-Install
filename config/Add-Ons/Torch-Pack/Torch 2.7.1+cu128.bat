...
%DIR_LVL%python_embeded\python.exe -I -m pip install torch==2.7.1 torchvision==0.22.1 torchaudio==2.7.1 --index-url https://download.pytorch.org/whl/cu128 %PIPargs%

%DIR_LVL%python_embeded\python.exe -I -m pip uninstall llama-cpp-python -y
..\..\python_embeded\python.exe -I -m pip install https://github.com/JamePeng/llama-cpp-python/releases/download/v0.3.38-cu128-Basic-win-20260504/llama_cpp_python-0.3.38+cu128.basic-cp312-cp312-win_amd64.whl %PIPargs%
echo.
